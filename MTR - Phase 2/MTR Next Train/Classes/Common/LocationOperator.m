...
-(void) locationManager:(CLLocationManager *)manager didUpdateToLocation:(CLLocation *)newLocation fromLocation:(CLLocation *)oldLocation {
    ...
    DEBUGMSG(@"didUpdateToLocation %f,%f",newLocation.coordinate.latitude,newLocation.coordinate.longitude);
...
-(float)distanceOfCurrentLocationFromLatitude:(NSString*)latitude longitude:(NSString*)longitude
{
    ...
    DEBUGMSG(@"Distance using Apple Location = %f", d);
...
+(float)distanceBetweenLat1:(NSString*)lat1 long1:(NSString*)long1 lat2:(NSString*)lat2 long2:(NSString*)long2
{
    ...
    DEBUGMSG(@"Distance using Law of Cosines = %f", d);
    */
    /*
    // Haversine
    ...
    DEBUGMSG(@"Distance using Haversine formula = %f", d2);
    */
    ...
    DEBUGMSG(@"Distance using Apple Location = %f", d3);
